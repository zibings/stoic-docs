...
<html lang="en">
	<head>
		<title>Documentation - Stoic Framework</title>
					...
					<div class="branding">
						<h1 class="logo">
							<a href="<?=$page->getAssetPath('~/index.php')?>">
								...
								<span class="text-highlight">Sto</span><span class="text-bold">ic</span>
							</a>
						</h1>      
					</div><!--//branding-->
					...
					<div id="doc-header" class="doc-header text-center">
						...
						<div class="meta btn-group">
							<div class="pt-1 mr-4 my-auto" style="height: 32px">
								<i class="far fa-clock"></i> Last updated: July 18th, 2018
							</div>
							...
							<div class="h-100">
								<div class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="versionDropdownButton">
										<a href="javascript: void(0);" class="dropdown-item">v0.5</a>
										<a href="javascript: void(0);" class="dropdown-item">v1.1 (Beta)</a>
									</div>
								</div>
							</div>
						</div>
