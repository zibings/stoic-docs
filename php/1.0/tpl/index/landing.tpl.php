					...
					<div id="cards-wrapper" class="cards-wrapper row cta-container">
						<div class="item item-green col-lg-4 col-6">
							<div class="item-inner">
								...
								<a class="link" href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'quick-start'])?>"><span></span></a>
							</div><!--//item-inner-->
						</div><!--//item-->
						...
						<div class="item item-pink item-2 col-lg-4 col-6">
							<div class="item-inner">
								...
								<a class="link" href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'components'])?>"><span></span></a>
							</div><!--//item-inner-->
						</div><!--//item-->
						...
						<div class="item item-purple col-lg-4 col-6">
							<div class="item-inner">
								...
								<a class="link" href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'toc'])?>"><span></span></a>
							</div><!--//item-inner-->
						</div><!--//item-->
					</div><!--//cards-->
