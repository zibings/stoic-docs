							...
							<div class="content-inner">
								<section id="io-brief" class="doc-section">
									<div class="section-block">
										<p>
											The <em>PDO</em> component contains a collection of utilities to simplify and/or streamline operations
									...
									<div class="section-block">
										...
										<div class="table-responsive">
											<table class="table">
												...
												<tbody>
													<tr>
														<td><a href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'pdo-basedbclass'])?>">BaseDbClass</a></td>
														<td>Utility that generalizes some functionality around user interaction on the command line</td>
													</tr>
													<tr>
														<td><a href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'pdo-basedbmodel'])?>">BaseDbModel</a></td>
