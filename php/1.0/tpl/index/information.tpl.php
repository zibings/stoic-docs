<?php $this->layout('shared::master', [
	...
	'breadcrumbs' => [
		...
		['text' => 'General Information', 'queryVars' => ['page' => 'information'], 'active' => true]
	],
	'title' => 'Stoic:PHP - General Information'
]); ?>
...
<?php $this->insert('shared::doc-header', [
   ...
   limitations under the License.
								...
								<section id="whats-next" class="doc-section">
									...
									<div class="section-block">
										<p>
											Continue to read about the <a href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'concepts'])?>">concepts</a>
											within Stoic:PHP, or visit the <a href="<?=$page->getAssetPath('~/php/1.0/', ['page' => 'toc'])?>">Table of Contents</a>.
										</p>
									</div>
								</section>
							</div><!--//content-inner-->
